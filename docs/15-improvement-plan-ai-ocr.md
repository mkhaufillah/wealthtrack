...
| 2.4 | Backend | **Model hardcoded to kimi-k2.6** — Line 88: `"model": "kimi-k2.6"`. Should use settings/config. | **P2** | ~5 min | **RESOLVED in v0.3.3** — Switched to `kimi-k2.5` (vision-capable, 60% higher rate limit than k2.6). Still hardcoded; config-based selection deferred. |

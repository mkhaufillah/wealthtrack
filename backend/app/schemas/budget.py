...
class BudgetCreate(BaseModel):
    ...
    category_id: int
    amount: int
    cycle_on: int | None = Field(None, ge=1, le=28, description="Override cycle day for this budget. If omitted, uses user's current cycle setting (new) or keeps original (update).")
